...
public class CountyController {
	...
	@GetMapping
	public ResponseEntity<Page<CountyView>> findAll(@RequestParam(value = "name", defaultValue = "") String name,
		...
		Page<CountyView> counties = service.findAllJoined(pageRequest);
